...
export type MessageHandler = (msg: MessageContents) => void;
...
export class Message {
    ...
    static from_json(json: string): MessageContents {
        return JSON.parse(json) as MessageContents;
    }

    static send(message: MessageContents) {
    ...
    static handle(message: MessageContents) {
